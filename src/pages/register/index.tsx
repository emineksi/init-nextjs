...
const Register = () => {
  ...
  const data = useState<RegisterRequestDto>({ email: '', password: '' })
  ...
  const onSubmit = (data: RegisterRequestDto) => {
    ...
    if (isApprove) {
      ...
      toast.error('Please mark that you accept the privacy policy and terms.')
    }
  }
          ...
          <CardContent sx={{ p: theme => `${theme.spacing(10.5, 8, 8)} !important` }}>
            ...
            <form
              ...
              onSubmit={handleSubmit(data => {
                const input = data as RegisterRequestDto
                onSubmit(input)
              })}
            >
              {/* <CustomTextField
              ...
              />
              <FormControlLabel
                control={<Checkbox checked={isApprove} onChange={e => setIsApprove(e.target.checked)} />}
                label={
